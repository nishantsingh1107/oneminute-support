        ...
        <section className='relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 overflow-hidden'>
            <div className='max-w-4xl mx-auto text-center relative z-20'>
                ...
                <p className='text-lg md:text-xl text-zinc-400 font-light mb-10 max-w-2xl mx-auto leading-relaxed'>
                    Instantly resolve customer questions with an assistant that reads your<br />docs and speaks with empathy. No robotic replies, just answers.
                </p>
                            ...
                            <div className='flex w-full flex-col items-start'>
                                <div className='flex max-w-[85%] gap-3 flex-row'>
                                    <div className='w-8 h-8 rounded-full overflow-hidden shrink-0'>
                                        <Image
                                            src="https://images.unsplash.com/photo-1613324996029-f6190a17838f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                                            alt="Support Agent"
                                            width={32}
                                            height={32}
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <div className='flex flex-wrap gap-2 pt-1 ml-1'>
                                            <span className='px-2 py-1.5 rounded-full border border-zinc-700 bg-zinc-800/50 text-zinc-300 text-sm font-medium cursor-default'>
                                                FAQ
                                            </span>
                                            <span className='px-2 py-1.5 rounded-full border border-zinc-700 bg-zinc-800/50 text-zinc-300 text-sm font-medium cursor-default'>
                                                Pricing
